<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InserisciPaziente.aspx.cs" Inherits="ProvaAPIWeb.InserisciPaziente" %>
	...
	<div class="container">
        ...
        <section class="container content-container">
            ...
            <fieldset>
				...
				<div class="form-group">
                    <label for="txtdatanascita">Sesso: <span style="color: red;">*</span></label>
				...
				<div class="form-group">
                    <label for="txtdatanascita">CAP: <span style="color: red;">*</span></label>
                ...
                <div class="form-group">
                    <label for="txtcodalbo">Codice Sanitario:</label>
                    <asp:TextBox ID="txtcodSanitario" runat="server" class="form-control"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label for="txtcodPaziente">Codice Medico:</label>
                    <asp:TextBox ID="txtcodMedico" runat="server" class="form-control"></asp:TextBox>
                    <br />
                    <asp:Button ID="btnSalva" runat="server" Text="Inserisci" Width="130px"  OnClick="btnSalva_Click"/>
                    <br />
                </div>
